const STORY = {
  ...
  jangsun_call: [
    { speaker: '유자평', text: '현덕, 마침 잘 왔네. 어양의 장순이 반란을 일으켜 관군을 격파했다 하네.' },
    { speaker: '유자평', text: '조정에서 이 난을 토벌할 의병을 모으고 있다네. 내 자네를 천거하겠네. 나서보겠나?' },
    { speaker: '유비', text: '나라를 위한 일이라면 마다할 이유가 없소.' },
  ],

  jangsun_battle_intro: [
    { speaker: '내레이션', text: '유비는 의용병들을 이끌고 장순 토벌군에 합류했다.' },
    { speaker: '관우', text: '형님, 위험합니다! 물러나셔야 합니다!' },
    { speaker: '내레이션', text: '관우와 장비는 반란군에 가로막혀 유비와 떨어지고 말았다.' },
    { speaker: '내레이션', text: '화살 하나가 유비의 어깨를 꿰뚫었다.' },
    { speaker: '내레이션', text: '유비는 병사들 틈에서 죽은 척 미동도 하지 않았다.' },
    { speaker: '병사', text: '저기… 저건 유 공 아닌가?!' },
    { speaker: '내레이션', text: '병사들이 유비를 수레에 실어 간신히 구해냈다.' },
    { speaker: '관우', text: '형님! 정신이 드십니까!' },
    { speaker: '유비', text: '…괜찮다. 아직 죽을 때가 아니야. 아우, 이제 그대의 군세가 나서야겠네.' },
  ],

  jangsun_defeat: [
    { speaker: '내레이션', text: '장순의 반란군은 생각보다 훨씬 거셌다.' },
    { speaker: '내레이션', text: '유비군은 크게 밀려나 물러섰다.' },
  ],
