const STORY = {
  ...
  jangsun_call: [
    ...
    { speaker: '유우', text: '성안 왼쪽 민가에서 백성들에게 명망 높은 인재가 있다 들었소.' },
  ],
  ...
  habi_yeopo_result: [
    ...
    { speaker: '유비', text: '정세가 혼란하니 병력을 강화해야 한다! 성 안 사람들에게 부탁하여 병사들을 모아보자.' },
  ],
  ...
  // 회수평야 탈출씬(main.js checkHoesuRetreat)에서 관우/유비 두 군세가 모두
  // 광릉行 관문에 도달하면 재생되는 승리 컷씬.
  hoesu_escape_win: [
    { speaker: '내레이션', text: '유비 일행은 마침내 추격을 뿌리치고 광릉 방면으로 무사히 빠져나갔다.' },
    { speaker: '유비', text: '다들 고생했네. 일단 몸을 추스르고 다음을 도모하세.' },
  ],

  // 연의 14회 - 원술이 유비를 아직 죽이지 못했다는 핑계로 여포와의 약조(보상)를
  ...
  sopae_arrival: [
    { speaker: '장비', text: '다시 또 이렇게 쫓기는 신세가 되다니...' },
  ...
  sopae_wonmunsageuk: [
    ...
    { speaker: '내레이션', text: '쐐액—!', scene: 'assets/illust/sopae_wonmun_arrow.jpg', holdMs: 3000 },
    { speaker: '병사들', text: '오오오오!!!', scene: 'assets/illust/sopae_wonmun_hit.jpg', holdMs: 3000 },
