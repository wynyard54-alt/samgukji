...
const STRATEGIES = {
  ...
  sinhwagye: { name: '신화계(神火計)', grade: 'S', desc: '적 군세 타일에 화염 피해. 이미 혼란/화염 상태면 피해 50% 증가. 전투당 1회', characters: ['juyu', 'yukson'], needsEnemy: true },
  sipmyeonmaebok: { name: '십면매복', grade: 'S', desc: '적 전체에 20% 즉시 피해 + 행동력 50% 감소(2턴), 동시에 적 2명 무작위 3턴 혼란. 전투당 1회', characters: ['jeongwook'], needsEnemy: true },
  isagyeollyu: { name: '이사결류', grade: 'S', desc: '적 전체에 20% 즉시 피해, 5턴간 행동력 50% 감소 + 타일이동시 필요 행동력 2배 증가. 전투당 1회', characters: ['gwakga'], needsEnemy: true },
  ...
  // ---- A급 ----
  palmungeumswaejin: { name: '팔문금쇄진', grade: 'A', desc: '3턴간 타겟 적군세 인접 3칸 영역의 모든 적 군세 무력 한 등급 감소, 책략 성공률 50% 감소. 월 1회', characters: ['seoseo'], needsEnemy: true },
  yeonhwangye: { name: '연환계', grade: 'A', desc: '3턴간 적 군세 5개를 연환 상태로 연결, 한 명이 받는 피해의 30%를 나머지도 공유. 월 1회', characters: ['bangtong'], needsEnemy: true },
  igangye: { name: '이간계', grade: 'A', desc: '타겟 적이 인접한 다른 적을 공격하게 함. 인접한 적이 다수면 전부 1회씩 공격(반격도 동일하게 받음). 월 1회', characters: ['gahu'], needsEnemy: true },
  ...
  // ---- B급 ----
  heosiljeonhwan: { name: '허실전환', grade: 'B', desc: '적 모든 버프를 제거하고 동일한 종류의 버프를 아군에게 복사', characters: ['jeonpung'], needsEnemy: true },
  toerobongswae: { name: '퇴로봉쇄', grade: 'B', desc: '2턴 내 적 군세를 제거하면 그 군세 내 장수를 반드시 포박', characters: ['nosuk'], needsEnemy: true },
  yueonbieo: { name: '유언비어', grade: 'B', desc: '적 전체 사기 10 감소, 사기 50 이하인 적은 혼란 발동', characters: ['goewol'], needsEnemy: true },
  gongsimgye: { name: '공심계', grade: 'B', desc: '적 전체 사기 10 감소, 사기 20 이하인 적은 퇴각 발동', characters: ['maseok'], needsEnemy: true },
  ...
  banmok: { name: '반목', grade: 'B', desc: '타겟 적이 인접한 다른 적 1명을 공격(반격도 동일하게 받음)', characters: ['gwakdo'], needsEnemy: true },
  heobo: { name: '허보', grade: 'B', desc: '타겟 적을 퇴각시킴 (전투중 1회 사용)', characters: ['dongso', 'gamtaek'], needsEnemy: true },
  ...
  gullyangchadan: { name: '군량차단', grade: 'B', desc: '타겟 적 군세 현재 군량을 30% 감소시킴', characters: ['jongyo', 'heoyu'], needsEnemy: true },
  uibyeongmojip: { name: '의병모집', grade: 'B', desc: '아군 1명의 현재 병력 20% 회복 + 사기 10 상승', characters: ['jegalgeun', 'jingun', 'noshik'] },
  yaseup: { name: '야습', grade: 'B', desc: '공격 가능 범위가 인접칸에서 인접 5칸으로 증가(병종 무관), 공격시 반격당하지 않음', characters: ['iyu'], needsEnemy: true },

  // ---- C급 ----
  giseup: { name: '기습', grade: 'C', desc: '전투 시작시 반드시 선제공격, 적 행동력 50% 감소', characters: ['huijijae', 'bonggi', 'seonggongyeong', 'jeongtak', 'gwakga'], needsEnemy: true },
  yeonnojihwi: { name: '연노지휘', grade: 'C', desc: '병종 궁병 군세에 적용, 다음 궁병 공격이 2회 발동', characters: ['gyun', 'jegalgak', 'yukjeok', 'ichan'] },
  sugong: { name: '수공', grade: 'C', desc: '3턴간 타겟 적 행동력 30% 감소, 타일이동시 필요 행동력 1.5배 증가', characters: ['jangso', 'bojeul', 'banjun', 'yukgae'], needsEnemy: true },
  hwagong: { name: '화공', grade: 'C', desc: '지정한 적 군세 타일을 화염화', characters: ['jangon', 'nakthong', 'ochan', 'hwahaek', 'juyu', 'yukson'], needsEnemy: true },
  hollan: { name: '혼란', grade: 'C', desc: '2턴간 타겟 적 혼란 상태', characters: ['wangyun', 'yangsong', 'jingyu', 'wanghae', 'heosa', 'hwanbeom'], needsEnemy: true },
  dobal: { name: '도발', grade: 'C', desc: '2턴간 타겟 적 도발 상태', characters: ['wangrang', 'yehyeong', 'imak', 'wangru', 'jinbok'], needsEnemy: true },
  // 공성계(空城計) - 서성에서 사마의를 상대로 성문을 열어두고 거문고를 탄
  // 일화를 반영해 제갈량에게도 배정한다(신풍(S) 보너스 - chaeryakbongswae는
  // 아직 구현 불가라 이걸로 교체).
  heojangseongse: { name: '허장성세', grade: 'C', desc: '2턴간 타겟 적 공포 상태', characters: ['eompo', 'sunsim', 'jangsong', 'gabeom', 'yunjik', 'gachung', 'jegallyang'], needsEnemy: true },
  maebok: { name: '매복', grade: 'C', desc: '다음 턴 공격에 적 반격 없음', characters: ['goeryang', 'busun', 'nugyu', 'sinpyeong', 'isuk', 'jeonju', 'jeongwook'], needsEnemy: true },
  ...
  chaeryakbongswae: { name: '책략봉쇄', grade: 'C', desc: '적 책사 1명이 2턴간 책략 사용 불가', characters: ['mogae', 'choeyeom', 'hwaheum', 'sinbi', 'jangje_wi', 'jingyo'], needsEnemy: true },
  wibo: { name: '위보', grade: 'C', desc: '적 1명의 공격력·지력 15% 감소, 3턴', characters: ['yeomsang', 'yanghong', 'paengyang', 'yupa', 'wonhwan', 'jubi'], needsEnemy: true },
  chiryo: { name: '치료', grade: 'C', desc: '아군 현재 병력 10% 회복', characters: ['yeoye', 'eomjun', 'dumi', 'jangye', 'wangryeol', 'sunyu'] },
  seondong: { name: '선동', grade: 'C', desc: '적 병력 일부 감소, 사기 -10 감소', characters: ['jinrim', 'chaeong', 'heoso', 'yangbu', 'sasonseo'], needsEnemy: true },
  jilju: { name: '질주', grade: 'C', desc: '아군 1명의 행동 게이지(행동력) 50% 증가', characters: ['deungji', 'jinjin', 'jongye', 'hansung'] },

  // ---- D급 ----
  gyeongmun: { name: '격문', grade: 'D', desc: '적 전체 사기 -5', characters: ['chojoo', 'geukjeong', 'naemin', 'yunmuk', 'bisi', 'heojeong', 'wangchan', 'eombaekho', 'heogong', 'jangmak'], needsEnemy: true },
