...
const ROSTER = {
  ...
  gwanhae: { id:'gwanhae', name:'관해', kind:'enemy', forced:null, affiliation:'황건적',
    stats:{atk:53, def:44, spd:40, int:26, cha:24}, intro:'크윽… 북해를 넘본 것이 실수였군. 그대들 밑에서 다시 시작해보겠소.' },
