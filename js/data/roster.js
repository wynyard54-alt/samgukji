...
const ROSTER = {
  ...
  mijuk: { id:'mijuk', name:'미축', kind:'recruit', forced:null, affiliation:'서주', chance:0.15,
    stats:{atk:18, def:22, spd:19, int:71, cha:78}, intro:'서주 상인 미축이오. 장사 일로 지나다, 소문을 듣고 인사나 드리려 왔소.', sprite:SPRITE_MERCHANT },
  ...
  jingyu: { id:'jingyu', name:'진규', kind:'recruit', forced:null, affiliation:'서주', chance:0.2,
    stats:{atk:20, def:24, spd:22, int:80, cha:70}, intro:'서주의 진규요. 내 아들 진등에게 그대들 이야기를 들었소.' },
  ...
  yujapyeong: { id:'yujapyeong', name:'유자평', kind:'flavor', affiliation:'평원',
    intro:'그대가 유현덕의 아우로군. 소문은 익히 들었네.', sprite:SPRITE_ELDER },
