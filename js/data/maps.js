...
(function () {
  MAPS.seoju_siege = {
    ...
    npcs:[
      ...
      { id:'jojo_jungong', x:14, y:19, label:'조조', fixed:true },
      { id:'habudon_seoju', x:4, y:16, label:'하후돈', fixed:true },
      { id:'habuyeon_seoju', x:3, y:19, label:'하후연', fixed:true },
      { id:'join_seoju', x:9, y:19, label:'조인', fixed:true },
      { id:'johong_seoju', x:12, y:19, label:'조홍', fixed:true },
      { id:'akjin_seoju', x:18, y:19, label:'악진', fixed:true },
      { id:'ijeon_seoju', x:20, y:17, label:'이전', fixed:true },
      { id:'ugeum_seoju', x:26, y:15, label:'우금', fixed:true },
