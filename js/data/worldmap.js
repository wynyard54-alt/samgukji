...
const WORLDMAP_FACTION_COLORS = {
  ...
  yubi: '#2f8f4e',         // 유비 (초록) - 챕터2 이후 사용 예정
  dogyeom: '#a3c93a',      // 도겸 (연두) - 챕터2 이후 사용 예정
  hwangeonjeok: '#ffe600', // 황건적 (밝은 노랑)
  hanna: '#ffffff',        // 한나라(챕터1 시점 세력 미정 지역) (하양)
...
const WORLDMAP_LOCATIONS = [
  ...
  { id: 'jadong', name: '자동', type: 'city', faction: 'hanna', x: 33.5, y: 49.7 },
  { id: 'yeogang', name: '여강', type: 'city', faction: 'hanna', x: 69.9, y: 49.7 },
  { id: 'geoneop', name: '건업', type: 'city', faction: 'hanna', x: 76.7, y: 47.9 },
  { id: 'yangpyeonggwan', name: '양평관', type: 'fort', faction: 'hanna', x: 38, y: 45.1 },
  ...
  { id: 'geomgak', name: '검각', type: 'fort', faction: 'hanna', x: 35.9, y: 46 },
